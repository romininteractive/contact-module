    ...
    <div class="row">
        <fieldset>
            ...
            <div class="col-sm-4">
                ...
                {!! Form::select('salutation', $user_salution, null, ['class' => 'form-control', 'tabindex'=> '1'] ) !!}
                <br/>
                {!! Form::normalInput('email', 'Email Address', $errors, '', ['tabindex'=> '5']) !!}
                {!! Form::normalInput('company_name', 'Company Name', $errors, '', ['tabindex'=>    '7']) !!}
            </div>
            <div class="col-sm-4">
                {!! Form::normalInput('first_name', 'First Name', $errors, '', ['tabindex'=> '2']) !!}
                {!! Form::normalInput('last_name', 'Last Name', $errors, '', ['tabindex'=> '3']) !!}
                {!! Form::normalInput('phone', 'Phone Number', $errors, null, ['class' => 'form-control','maxlength' => 10, 'onkeypress' => 'return isNumber(event)','tabindex'=>  '8'] ) !!}
                {!! Form::normalInput('department', 'Department', $errors, '', ['tabindex'=> '9']) !!}
            </div>
            <div class="col-sm-4">
                {!! Form::normalInput('gstin', 'GSTIN', $errors, '', ['tabindex'=> '4']) !!}
                {!! Form::normalInput('designation', 'Designation', $errors, '', ['tabindex'=> '6']) !!}
            </div>
        </fieldset>
    </div>
